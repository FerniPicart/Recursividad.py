...
print(formula_ej25(8))
#EJ 


#Ej 24
#El valor 1 376 256 pertenece a una sucesión geométrica cuya razón es 4, implementar un 
#algoritmo para mostrar todos los valores de la sucesión hacia atrás hasta el valor de a1= 5,25.





#FALTAN 15,16,19,22,24,26,27,28